        ...
        <div class="clearfix">
            <div class="custom_scrollbar">
                ...
                <div class="f_right half_column">
                    <!--description-->
                    <h2 class="m_bottom_10"><a href="#" class="color_dark ellipsis fw_medium"><?php print $title; ?></a></h2>
                    ...
                    <table class="description_table m_bottom_10">
                        ...
                        <?php endif;?>
                        <?php if(isset($content['product:sku'])):?>
                            <tr>
                                <td><?php print t('Product Code:');?></td>
                                <td><?php print render($content['product:sku']);?></td>
                            </tr>
                        <?php endif;?>
                    </table>
